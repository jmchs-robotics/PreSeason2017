...
public class RobotMap {
    ...
    public static CANTalon drivetrainThirdLeft;
    public static CANTalon drivetrainFrontRight;
    public static CANTalon drivetrainBackRight;
    public static CANTalon drivetrainThirdRight; //third Reich :)
    ...
    public static void init() {
        ...
        pneumaticsFrontSolenoid = new DoubleSolenoid(4, 3, 2);
        ...
        drivetrainThirdLeft = new CANTalon(8);
        LiveWindow.addActuator("Drivetrain", "ThirdLeft", drivetrainThirdLeft);
        ...
        drivetrainThirdRight = new CANTalon(5);
        LiveWindow.addActuator("Drivetrain", "ThirdRight", drivetrainThirdRight);
