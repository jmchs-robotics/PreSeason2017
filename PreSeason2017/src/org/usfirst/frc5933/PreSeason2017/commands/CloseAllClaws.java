 ...
 *
 */
public class CloseAllClaws extends Command {
	
	long endMillis;
	Value val = Value.kOff;
    ...
    protected void initialize() {
    	if(Robot.pneumatics.solenoidPos != Value.kReverse) {
    		val = Value.kReverse;
    	}

		Robot.pneumatics.setClaws(val);
